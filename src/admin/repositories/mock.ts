    ...
    return delay(
      {
        ...
        cities: [
          { city: "Springfield", region: "MO", country: "US", value: Math.round(visitors * 0.22) },
          { city: "Kansas City", region: "MO", country: "US", value: Math.round(visitors * 0.14) },
          { city: "St. Louis", region: "MO", country: "US", value: Math.round(visitors * 0.11) },
          { city: "Tulsa", region: "OK", country: "US", value: Math.round(visitors * 0.05) },
          { city: "Toronto", region: "ON", country: "CA", value: Math.round(visitors * 0.03) },
        ],
        regions: [
          { region: "MO", country: "US", value: Math.round(visitors * 0.55) },
          { region: "AR", country: "US", value: Math.round(visitors * 0.09) },
          { region: "OK", country: "US", value: Math.round(visitors * 0.07) },
          { region: "ON", country: "CA", value: Math.round(visitors * 0.03) },
        ],
        recentVisitors: [
          {
            ...
            device: "mobile",
            referrer: "google.com",
            lastPage: "/shop/card/sol-ring-cmm-410",
            pages: 4,
          },
          {
            lastSeen: new Date(Date.now() - 38 * 60_000).toISOString(),
            city: "Tulsa",
            region: "OK",
            country: "US",
            device: "desktop",
            referrer: null,
            lastPage: "/sell-my-collection",
            pages: 2,
          },
          {
